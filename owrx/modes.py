...
class Modes(object):
    mappings = [
        ...
        AnalogMode("lsb", "LSB", bandpass=Bandpass(-3100, -50)),
        AnalogMode("usb", "USB", bandpass=Bandpass(50, 3100)),
        ...
        AnalogMode("rade-l", "RADE-L", bandpass=Bandpass(-3000, -300), requirements=["digital_voice_rade"], squelch=False),
        AnalogMode("rade", "RADE-U", bandpass=Bandpass(300, 3000), requirements=["digital_voice_rade"], squelch=False),
